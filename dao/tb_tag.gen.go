...
func newTag(db *gorm.DB, opts ...gen.DOOption) tag {
	...
	_tag.tagDo.UseModel(&model_def.Tag{})
...
type ITagDo interface {
	...
	Unscoped() ITagDo
	Create(values ...*model_def.Tag) error
	CreateInBatches(values []*model_def.Tag, batchSize int) error
	Save(values ...*model_def.Tag) error
	First() (*model_def.Tag, error)
	Take() (*model_def.Tag, error)
	Last() (*model_def.Tag, error)
	Find() ([]*model_def.Tag, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_def.Tag, err error)
	FindInBatches(result *[]*model_def.Tag, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model_def.Tag) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model_def.Tag, error)
	FirstOrCreate() (*model_def.Tag, error)
	FindByPage(offset int, limit int) (result []*model_def.Tag, count int64, err error)
...
func (t tagDo) Create(values ...*model_def.Tag) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagDo) CreateInBatches(values []*model_def.Tag, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tagDo) Save(values ...*model_def.Tag) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagDo) First() (*model_def.Tag, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_def.Tag), nil
	}
}

func (t tagDo) Take() (*model_def.Tag, error) {
...
func (t tagDo) Last() (*model_def.Tag, error) {
...
func (t tagDo) Find() ([]*model_def.Tag, error) {
	result, err := t.DO.Find()
	return result.([]*model_def.Tag), err
}

func (t tagDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_def.Tag, err error) {
	buf := make([]*model_def.Tag, 0, batchSize)
...
func (t tagDo) FindInBatches(result *[]*model_def.Tag, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tagDo) FirstOrInit() (*model_def.Tag, error) {
...
func (t tagDo) FirstOrCreate() (*model_def.Tag, error) {
...
func (t tagDo) FindByPage(offset int, limit int) (result []*model_def.Tag, count int64, err error) {
...
func (t tagDo) Delete(models ...*model_def.Tag) (result gen.ResultInfo, err error) {
