...
func newArticle(db *gorm.DB, opts ...gen.DOOption) article {
	...
	_article.articleDo.UseModel(&model_def.Article{})
...
type IArticleDo interface {
	...
	Unscoped() IArticleDo
	Create(values ...*model_def.Article) error
	CreateInBatches(values []*model_def.Article, batchSize int) error
	Save(values ...*model_def.Article) error
	First() (*model_def.Article, error)
	Take() (*model_def.Article, error)
	Last() (*model_def.Article, error)
	Find() ([]*model_def.Article, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_def.Article, err error)
	FindInBatches(result *[]*model_def.Article, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model_def.Article) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model_def.Article, error)
	FirstOrCreate() (*model_def.Article, error)
	FindByPage(offset int, limit int) (result []*model_def.Article, count int64, err error)
...
func (a articleDo) Create(values ...*model_def.Article) error {
	if len(values) == 0 {
		return nil
	}
...
func (a articleDo) CreateInBatches(values []*model_def.Article, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a articleDo) Save(values ...*model_def.Article) error {
	if len(values) == 0 {
		return nil
	}
...
func (a articleDo) First() (*model_def.Article, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_def.Article), nil
	}
}

func (a articleDo) Take() (*model_def.Article, error) {
...
func (a articleDo) Last() (*model_def.Article, error) {
...
func (a articleDo) Find() ([]*model_def.Article, error) {
	result, err := a.DO.Find()
	return result.([]*model_def.Article), err
}

func (a articleDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_def.Article, err error) {
	buf := make([]*model_def.Article, 0, batchSize)
...
func (a articleDo) FindInBatches(result *[]*model_def.Article, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a articleDo) FirstOrInit() (*model_def.Article, error) {
...
func (a articleDo) FirstOrCreate() (*model_def.Article, error) {
...
func (a articleDo) FindByPage(offset int, limit int) (result []*model_def.Article, count int64, err error) {
...
func (a articleDo) Delete(models ...*model_def.Article) (result gen.ResultInfo, err error) {
