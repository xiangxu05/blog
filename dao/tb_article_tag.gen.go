...
func newArticleTag(db *gorm.DB, opts ...gen.DOOption) articleTag {
	...
	_articleTag.articleTagDo.UseModel(&model_def.ArticleTag{})
...
type IArticleTagDo interface {
	...
	Create(values ...*model_def.ArticleTag) error
	CreateInBatches(values []*model_def.ArticleTag, batchSize int) error
	Save(values ...*model_def.ArticleTag) error
	First() (*model_def.ArticleTag, error)
	Take() (*model_def.ArticleTag, error)
	Last() (*model_def.ArticleTag, error)
	Find() ([]*model_def.ArticleTag, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_def.ArticleTag, err error)
	FindInBatches(result *[]*model_def.ArticleTag, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model_def.ArticleTag) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model_def.ArticleTag, error)
	FirstOrCreate() (*model_def.ArticleTag, error)
	FindByPage(offset int, limit int) (result []*model_def.ArticleTag, count int64, err error)
...
func (a articleTagDo) Create(values ...*model_def.ArticleTag) error {
	if len(values) == 0 {
		return nil
	}
...
func (a articleTagDo) CreateInBatches(values []*model_def.ArticleTag, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a articleTagDo) Save(values ...*model_def.ArticleTag) error {
	if len(values) == 0 {
		return nil
	}
...
func (a articleTagDo) First() (*model_def.ArticleTag, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_def.ArticleTag), nil
	}
}

func (a articleTagDo) Take() (*model_def.ArticleTag, error) {
...
func (a articleTagDo) Last() (*model_def.ArticleTag, error) {
...
func (a articleTagDo) Find() ([]*model_def.ArticleTag, error) {
	result, err := a.DO.Find()
	return result.([]*model_def.ArticleTag), err
}

func (a articleTagDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_def.ArticleTag, err error) {
	buf := make([]*model_def.ArticleTag, 0, batchSize)
...
func (a articleTagDo) FindInBatches(result *[]*model_def.ArticleTag, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a articleTagDo) FirstOrInit() (*model_def.ArticleTag, error) {
...
func (a articleTagDo) FirstOrCreate() (*model_def.ArticleTag, error) {
...
func (a articleTagDo) FindByPage(offset int, limit int) (result []*model_def.ArticleTag, count int64, err error) {
...
func (a articleTagDo) Delete(models ...*model_def.ArticleTag) (result gen.ResultInfo, err error) {
