...
func newCategory(db *gorm.DB, opts ...gen.DOOption) category {
	...
	_category.categoryDo.UseModel(&model_def.Category{})
...
type ICategoryDo interface {
	...
	Create(values ...*model_def.Category) error
	CreateInBatches(values []*model_def.Category, batchSize int) error
	Save(values ...*model_def.Category) error
	First() (*model_def.Category, error)
	Take() (*model_def.Category, error)
	Last() (*model_def.Category, error)
	Find() ([]*model_def.Category, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_def.Category, err error)
	FindInBatches(result *[]*model_def.Category, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model_def.Category) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model_def.Category, error)
	FirstOrCreate() (*model_def.Category, error)
	FindByPage(offset int, limit int) (result []*model_def.Category, count int64, err error)
...
func (c categoryDo) Create(values ...*model_def.Category) error {
	if len(values) == 0 {
		return nil
	}
...
func (c categoryDo) CreateInBatches(values []*model_def.Category, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c categoryDo) Save(values ...*model_def.Category) error {
	if len(values) == 0 {
		return nil
	}
...
func (c categoryDo) First() (*model_def.Category, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_def.Category), nil
	}
}

func (c categoryDo) Take() (*model_def.Category, error) {
...
func (c categoryDo) Last() (*model_def.Category, error) {
...
func (c categoryDo) Find() ([]*model_def.Category, error) {
	result, err := c.DO.Find()
	return result.([]*model_def.Category), err
}

func (c categoryDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_def.Category, err error) {
	buf := make([]*model_def.Category, 0, batchSize)
...
func (c categoryDo) FindInBatches(result *[]*model_def.Category, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c categoryDo) FirstOrInit() (*model_def.Category, error) {
...
func (c categoryDo) FirstOrCreate() (*model_def.Category, error) {
...
func (c categoryDo) FindByPage(offset int, limit int) (result []*model_def.Category, count int64, err error) {
...
func (c categoryDo) Delete(models ...*model_def.Category) (result gen.ResultInfo, err error) {
