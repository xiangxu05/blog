...
func newSession(db *gorm.DB, opts ...gen.DOOption) session {
	...
	_session.sessionDo.UseModel(&model_def.Session{})
	...
	_session.Ctime = field.NewInt64(tableName, "ctime")
	_session.Etime = field.NewInt64(tableName, "etime")
...
func (s *session) updateTableName(table string) *session {
	...
	s.Etime = field.NewInt64(table, "etime")
...
type ISessionDo interface {
	...
	Unscoped() ISessionDo
	Create(values ...*model_def.Session) error
	CreateInBatches(values []*model_def.Session, batchSize int) error
	Save(values ...*model_def.Session) error
	First() (*model_def.Session, error)
	Take() (*model_def.Session, error)
	Last() (*model_def.Session, error)
	Find() ([]*model_def.Session, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_def.Session, err error)
	FindInBatches(result *[]*model_def.Session, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model_def.Session) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model_def.Session, error)
	FirstOrCreate() (*model_def.Session, error)
	FindByPage(offset int, limit int) (result []*model_def.Session, count int64, err error)
...
func (s sessionDo) Create(values ...*model_def.Session) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sessionDo) CreateInBatches(values []*model_def.Session, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sessionDo) Save(values ...*model_def.Session) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sessionDo) First() (*model_def.Session, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_def.Session), nil
	}
}

func (s sessionDo) Take() (*model_def.Session, error) {
...
func (s sessionDo) Last() (*model_def.Session, error) {
...
func (s sessionDo) Find() ([]*model_def.Session, error) {
	result, err := s.DO.Find()
	return result.([]*model_def.Session), err
}

func (s sessionDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_def.Session, err error) {
	buf := make([]*model_def.Session, 0, batchSize)
...
func (s sessionDo) FindInBatches(result *[]*model_def.Session, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sessionDo) FirstOrInit() (*model_def.Session, error) {
...
func (s sessionDo) FirstOrCreate() (*model_def.Session, error) {
...
func (s sessionDo) FindByPage(offset int, limit int) (result []*model_def.Session, count int64, err error) {
...
func (s sessionDo) Delete(models ...*model_def.Session) (result gen.ResultInfo, err error) {
